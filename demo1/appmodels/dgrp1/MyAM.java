...
public class MyAM extends AppModelBase {		private AdvantageShoppingPage AdvantageShoppingPage;
	
	public MyAM(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("MyAM");
	...
	private Total_Cart_Amt Total_Cart_Amt;
	private Item_Amount Item_Amount;
	private Item_quantity Item_quantity;
						public AdvantageShoppingPage(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
					...
					CheckOutBtnButton = new CheckOutBtnButton(this, applicationModel);
		Total_Cart_Amt = new Total_Cart_Amt(this, applicationModel);
		Item_Amount = new Item_Amount(this, applicationModel);
		Item_quantity = new Item_quantity(this, applicationModel);
		...
		public Total_Cart_Amt Total_Cart_Amt() { return Total_Cart_Amt; }
		public Item_Amount Item_Amount() { return Item_Amount; }
		public Item_quantity Item_quantity() { return Item_quantity; }
			...
			public class CheckOutBtnButton extends ButtonNodeBase
	{
		...
		protected com.hp.lft.sdk.web.ButtonDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.ButtonDescription.Builder().buttonType("submit").id("checkOutButton").name(new RegExpProperty("CHECKOUT \\(\\$.*")).tagName("BUTTON").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class Total_Cart_Amt extends WebElementNodeBase
	{

		
								public Total_Cart_Amt(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("Total_Cart_Amt");
		}
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().className("roboto-medium ng-binding").innerText(new RegExpProperty("\\$.*")).tagName("SPAN").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class Item_Amount extends WebElementNodeBase
	{

		
								public Item_Amount(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("Item_Amount");
		}
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.WebElementDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().accessibilityName("").className("price roboto-regular ng-binding").tagName("P").index(1).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class Item_quantity extends WebElementNodeBase
	{

		
								public Item_quantity(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("Item_quantity");
		}
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.WebElementDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().innerText(new RegExpProperty("QUANTITY \\d* ")).tagName("TD").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
